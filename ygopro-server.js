...
(function() {
  ...
  delete_outdated_cores = global.delete_outdated_cores = function() {
    var len3, n, ref2, room;
    if (settings.live_core) {
      update_core_paths();
      ref2 = CORES_list.slice(0).pop();
      for (n = 0, len3 = ref2.length; n < len3; n++) {
        path = ref2[n];
  ...
  CLIENT_import_data = global.CLIENT_import_data = function(client, old_client, room) {
    var index, key, len3, len4, n, o, player, ref2;
    ref2 = room.players;
    for (index = n = 0, len3 = ref2.length; n < len3; index = ++n) {
      player = ref2[index];
  ...
  CLIENT_is_player = global.CLIENT_is_player = function(client, room) {
    var is_player, len3, n, player, ref2;
    is_player = false;
    ref2 = room.players;
    for (n = 0, len3 = ref2.length; n < len3; n++) {
      player = ref2[n];
  ...
  CLIENT_get_kick_reconnect_target = global.CLIENT_get_kick_reconnect_target = function(client, deckbuf) {
    var len3, len4, n, o, player, ref2, room;
  ...
  CLIENT_send_pre_reconnect_info = global.CLIENT_send_pre_reconnect_info = function(client, room, old_client) {
    var len3, n, player, ref2, req_pos;
  ...
  Room = (function() {
    function Room(hostinfo) {
      ...
      this.unique_id = new Date().getTime() + this.cloud_replay_id;
      ROOM_all.push(this);
      try {
    ...
    Room.prototype["delete"] = function() {
      var end_time, formatted_replays, index, len3, log_rep_id, n, name, player_ips, player_names, recorder_buffer, ref2, ref3, repbuf, replay_id, room_name, score, score_array, score_form;
      if (this.deleted) {
        return;
      }
      score_array = [];
    ...
    Room.prototype.set_duel_info = function(hostinfo) {
      this.hostinfo = hostinfo;
      return ROOM_all.push(this);
    };

    Room.prototype.get_disconnected_count = function() {
      var found, len3, n, player, ref2;
      if (!settings.modules.reconnect.enabled) {
        return 0;
      }
      found = 0;
    ...
    Room.prototype.send_replays = function() {
      var len3, len4, n, o, player, ref2, ref3;
    ...
    Room.prototype.disconnect = function(client, error) {
      var index, left_name, len3, len4, n, o, player, ref2, ref3;
      if (client.had_new_reconnection) {
        return;
      }
  ...
  net.createServer(function(client) {
    ...
    client.on('data', function(ctos_buffer) {
      var b, bad_ip_count, buffer, cancel, ctos_event, ctos_message_length, ctos_proto, datas, info, len3, len4, len5, len6, looplimit, n, o, p, q, ref2, ref3, result, room, struct;
      if (client.is_post_watcher) {
        room = ROOM_all[client.rid];
    ...
    server.on('data', function(stoc_buffer) {
      var b, buffer, cancel, datas, info, len3, len4, len5, looplimit, n, o, p, ref2, ref3, result, stoc_event, stoc_message_length, stoc_proto, struct;
  ...
  ygopro.stoc_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var len3, n, player, recorder, ref2, room, watcher;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server, datas) {
    ...
    if (settings.modules.heartbeat_detection.enabled && ygopro.constants.MSG[msg] === 'CONFIRM_CARDS') {
      ...
      deck_found = 0;
      limbo_found = 0;
      for (i = o = 3, ref5 = max_loop; o <= ref5; i = o += 7) {
  ...
  ygopro.stoc_follow('HS_PLAYER_CHANGE', false, function(buffer, info, client, server, datas) {
    var is_ready, len3, len4, n, o, p1, p2, player, pos, ref2, ref3, room;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('DUEL_END', false, function(buffer, info, client, server, datas) {
    var len3, len4, n, o, player, ref2, ref3, results, room;
    room = ROOM_all[client.rid];
  ...
  wait_room_start_arena = function(room) {
    var display_name, len3, n, player, ref2;
  ...
  ygopro.stoc_follow('DUEL_START', false, function(buffer, info, client, server, datas) {
    var deck_arena, deck_name, deck_text, len3, len4, n, o, player, ref2, ref3, room;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
  ...
  ygopro.ctos_follow('UPDATE_DECK', true, function(buffer, info, client, server, datas) {
    var buff_main, buff_side, card, current_deck, deck, deck_array, deck_main, deck_side, deck_text, deckbuf, decks, found_deck, i, len3, len4, line, n, o, oppo_pos, room, struct, win_pos;
    ...
    buff_main = (function() {
      var n, ref2, results;
      results = [];
      for (i = n = 0, ref2 = info.mainc; 0 <= ref2 ? n < ref2 : n > ref2; i = 0 <= ref2 ? ++n : --n) {
    ...
    buff_side = (function() {
      ...
      results = [];
      for (i = n = ref2 = info.mainc, ref3 = info.mainc + info.sidec; ref2 <= ref3 ? n < ref3 : n > ref3; i = ref2 <= ref3 ? ++n : --n) {
        results.push(info.deckbuf[i]);
      }
      return results;
    })();
  ...
  ygopro.stoc_follow('CHAT', true, function(buffer, info, client, server, datas) {
    var len3, n, pid, player, ref2, room, tcolor, tplayer;
    room = ROOM_all[client.rid];
    pid = info.player;
  ...
  ygopro.stoc_follow('REPLAY', true, function(buffer, info, client, server, datas) {
    var duellog, dueltime, i, len3, len4, n, o, player, ref2, ref3, replay_filename, room;
    room = ROOM_all[client.rid];
    if (!room) {
  ...
  if (settings.modules.http) {
    ...
    requestListener = function(request, response) {
      var archive_args, archive_name, archive_process, check, death_room_found, duellog, error, filename, getpath, kick_room_found, len3, len4, len5, len6, len7, len8, n, o, p, parseQueryString, pass_validated, player, q, r, ref2, replay, room, roomsjson, s, u;
