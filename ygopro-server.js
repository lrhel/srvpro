...
(function() {
  ...
  ROOM_find_or_create_ai = global.ROOM_find_or_create_ai = function(name) {
    var ainame, namea, result, uname, windbot;
    if (name === '') {
      name = 'AI';
    }
    namea = name.split('#');
  ...
  net.createServer(function(client) {
    ...
    client.on('data', function(ctos_buffer) {
      var b, bad_ip_count, buffer, cancel, ctos_event, ctos_message_length, ctos_proto, datas, info, len4, len5, len6, len7, looplimit, o, p, q, r, ref3, ref4, result, struct;
      if (client.is_post_watcher) {
        room = ROOM_all[client.rid];
    ...
    server.on('data', function(stoc_buffer) {
      var b, buffer, cancel, datas, info, len4, len5, len6, looplimit, o, p, q, ref3, ref4, result, stoc_event, stoc_message_length, stoc_proto, struct;
  ...
  ygopro.stoc_follow('JOIN_GAME', false, function(buffer, info, client, server, datas) {
    var len4, o, player, recorder, ref3, watcher;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('GAME_MSG', true, function(buffer, info, client, server, datas) {
    var card, chain, check, count, cpos, deck_found, found, hint_type, i, id, len4, len5, len6, len7, limbo_found, line, loc, max_loop, msg, o, oppo_pos, p, phase, player, playertype, pos, ppos, q, r, reason, ref3, ref4, ref5, ref6, ref7, ref8, s, trigger_location, val, win_pos;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
  ...
  ygopro.stoc_follow('HS_PLAYER_CHANGE', false, function(buffer, info, client, server, datas) {
    var is_ready, len4, len5, o, p, p1, p2, player, pos, ref3, ref4;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('DUEL_END', false, function(buffer, info, client, server, datas) {
    var len4, len5, o, p, player, ref3, ref4, results;
    room = ROOM_all[client.rid];
  ...
  ygopro.stoc_follow('DUEL_START', false, function(buffer, info, client, server, datas) {
    var deck_arena, deck_name, deck_text, len4, len5, o, p, player, ref3, ref4;
    room = ROOM_all[client.rid];
    if (!(room && !client.reconnecting)) {
      return;
    }
  ...
  ygopro.ctos_follow('CHAT', true, function(buffer, info, client, server, datas) {
    var cancel, ccolor, cip, cmd, cmsg, cname, color, cvalue, msg, name, oldmsg, ref3, struct, windbot;
    room = ROOM_all[client.rid];
    if (!room) {
      return;
    }
  ...
  ygopro.ctos_follow('UPDATE_DECK', true, function(buffer, info, client, server, datas) {
    var buff_main, buff_side, card, current_deck, deck, deck_array, deck_main, deck_side, deck_text, deckbuf, decks, found_deck, i, len4, len5, line, o, oppo_pos, p, struct, win_pos;
  ...
  ygopro.stoc_follow('CHAT', true, function(buffer, info, client, server, datas) {
    var len4, o, pid, player, ref3, tcolor, tplayer;
    room = ROOM_all[client.rid];
    pid = info.player;
  ...
  ygopro.stoc_follow('CHANGE_SIDE', false, function(buffer, info, client, server, datas) {
    var room_name, sinterval, temp_log;
    room = ROOM_all[client.rid];
    if (!room) {
      return;
    }
  ...
  ygopro.stoc_follow('REPLAY', true, function(buffer, info, client, server, datas) {
    var duellog, dueltime, i, len4, len5, o, p, player, ref3, ref4, replay_filename;
    room = ROOM_all[client.rid];
    if (!room) {
  ...
  if (settings.modules.mycard.enabled) {
    setInterval(function() {
      var len4, len5, o, p, player, time_passed, waited_time;
      for (o = 0, len4 = ROOM_all.length; o < len4; o++) {
        room = ROOM_all[o];
  ...
  setInterval(function() {
    var current_time, len4, o, results;
    current_time = moment();
    results = [];
    for (o = 0, len4 = ROOM_all.length; o < len4; o++) {
      room = ROOM_all[o];
  ...
  if (settings.modules.http) {
    ...
    requestListener = function(request, response) {
      var archive_args, archive_name, archive_process, check, death_room_found, duellog, error, filename, getpath, kick_room_found, len4, len5, len6, len7, len8, len9, o, p, parseQueryString, pass_validated, player, q, r, ref3, replay, roomsjson, s, t, u;
