...
(function() {
  ...
  Room = (function() {
    function Room(info) {
      ...
      ROOM_all.push(this);
      try {
        this.process = spawn((this.core_path ? '/../' + core_path + '/./ygopro' : './ygopro'), [], {
          cwd: 'ygopro'
        });
